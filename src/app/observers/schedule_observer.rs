use crate::app::models::schedule::Model as Schedule;
use rustbasic_core::serde_json::Value;

pub trait ScheduleObserver {
    fn creating(data: &mut Value);
    fn created(model: &Schedule);
    fn updating(data: &mut Value);
    fn updated(model: &Schedule);
    fn deleting(id: i32);
    fn deleted(id: i32);
}

pub struct ScheduleObserverImpl;

impl ScheduleObserver for ScheduleObserverImpl {
    fn creating(data: &mut Value) {
