  ...
  return (
    <div className="space-y-12 animate-fade-in">
      <div className="text-center max-w-2xl mx-auto space-y-4">
        ...
        <h2 className="font-serif text-4xl sm:text-5xl font-black">Adat Pusako, <br />Kreativitas Tanpa Batas.</h2>
        <p className="text-slate-600 dark:text-white/60 font-light text-base">Didirikan di Kenagarian Sisawah, Sijunjung, kami berdedikasi menjaga warisan leluhur melalui teater Randai dan kesenian tradisional Minangkabau.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="p-8 sm:p-12 rounded-[32px] bg-white dark:bg-[#141417]/80 border border-slate-200 dark:border-white/5 shadow-md dark:shadow-none space-y-6">
          ...
          <h3 className="font-serif text-3xl font-extrabold text-slate-800 dark:text-white">Terinspirasi Keindahan Ngalau Antabuang</h3>
          <p className="text-slate-600 dark:text-white/77 text-base leading-relaxed font-light">
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-white/5 text-sm text-slate-500 dark:text-white/50 leading-relaxed italic">
            "Kesenian Randai di Sisawah bukan sekadar hiburan, melainkan sarana musyawarah adat dan penyampaian petuah moral kehidupan."
          </div>
        </div>
        ...
        <div className="p-8 sm:p-12 rounded-[32px] bg-white dark:bg-[#141417]/80 border border-slate-200 dark:border-white/5 shadow-md dark:shadow-none space-y-6">
          ...
          <h3 className="font-serif text-3xl font-extrabold text-slate-800 dark:text-white">Pilar Kebudayaan Nagari Sisawah</h3>
          <ul className="space-y-4 text-base font-light text-slate-600 dark:text-slate-300">
            <li className="flex items-start gap-4">
              ...
              <span>Melestarikan randai, musik Talempong Ungah, dan seni tari tradisi di kalangan anak sasian (generasi muda).</span>
            </li>
            <li className="flex items-start gap-4">
              <span className="w-6 h-6 rounded-lg bg-[#10b981]/20 text-[#10b981] flex items-center justify-center shrink-0 mt-1"><i className="fas fa-check text-sm"></i></span>
              <span>Mengintegrasikan pementasan seni tradisi sebagai daya tarik pariwisata unggulan Desa Wisata Nagari Sisawah.</span>
            </li>
            <li className="flex items-start gap-4">
              <span className="w-6 h-6 rounded-lg bg-[#10b981]/20 text-[#10b981] flex items-center justify-center shrink-0 mt-1"><i className="fas fa-check text-sm"></i></span>
              <span>Memanfaatkan media digital untuk mengenalkan keelokan budaya Sijunjung ke mata dunia internasional.</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <h3 className="font-serif text-3xl font-extrabold text-center text-slate-800 dark:text-white">Struktur Pengurus & Tokoh Adat</h3>
